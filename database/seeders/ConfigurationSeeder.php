    ...
    public function run()
    {
        ...
        Configuration::upsert([
            ...
            [
                ...
                'secret' => false,
                'group' => 'access',
                'choices' => json_encode(['KUDISMS', 'TWILLIO', 'TERMII']),
            ],
            [
                'key' => 'prefered_otp_channel',
                'title' => 'Prefered OTP Channel',
                'value' => 'DEFAULT',
                'type' => 'string',
                'count' => null,
                'max' => null,
                'col' => 6,
                'autogrow' => false,
                'hint' => 'Which channel should be prefered when sending OTP',
                'secret' => false,
                'group' => 'access',
                'choices' => json_encode(['DEFAULT', 'TERMII_TOKEN', 'TERMII_VOICE', 'TERMII_EMAIL_TOKEN', 'TERMII_VOICE_TOKEN']),
            ],
            [
            ...
            [
                'key' => 'send_verified_message',
                'title' => 'Send Verified Message',
                'value' => true,
                'type' => 'boolean',
                'count' => null,
                'max' => null,
                'col' => 6,
                'autogrow' => false,
                'hint' => 'Whether to send welcome message after verification',
                'secret' => false,
                'group' => 'access',
                'choices' => json_encode([]),
            ],
            ...
            [
                'key' => 'disable_email_banners',
                'title' => 'Disable Email Banners',
                'value' => false,
                'type' => 'boolean',
                'count' => null,
                'max' => null,
                'col' => 6,
                'autogrow' => false,
                'hint' => 'If enabled, email will not contain banners.',
                'secret' => false,
                'group' => 'misc',
                'choices' => json_encode([]),
            ],
            [
                ...
                'col' => 12,
                'autogrow' => true,
                'hint' => 'Which features should be disabled and hidden out',
                'secret' => false,
                'group' => 'access',
                'choices' => json_encode(['forms', 'companies', 'appointments', 'reschedules', 'users', 'personal']),
            ],
